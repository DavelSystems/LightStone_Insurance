...
////        }
	...
	{	       
	   ...
	   //get values
        ...
        var stat = document.getElementById("ddlstatus").value
        var report = document.all("ddlreportlist").value;
        
	    var strLoc = "ReportsPopUp.aspx?prop=" + props + "&stat=" + stat + "&fromdate=" + fromdate + "&todate=" + todate + "&report=" + report;
             ...
             <tr><td>&nbsp;</td></tr>
                ...
                <tr>
                    <td class="labelText" style="vertical-align: baseline;" >
                        Property:</td>
                    <td >
                        <asp:DropDownList ID="ddlprop" runat="server" Width="394px">
                        </asp:DropDownList>
                    </td>
                    <!--<td>
